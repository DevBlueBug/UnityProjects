...
public class PlayerManager : MonoBehaviour
{
	...
	public void E_GetNewPlayer(){
		...
		player.entity.inventory.Add (player.entity, NItem.Item.Get(NItem.Item.KId.Equip_Body_default));
		player.entity.inventory.Add (player.entity, NItem.Item.Get(NItem.Item.KId.Equip_Head_Default));
	}
